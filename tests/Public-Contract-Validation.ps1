...
foreach ($name in @('Get-WindowsDeviceLinkLocalAssociation','Get-WindowsDeviceLinkRepairPlan','Test-WindowsDeviceLinkPreflight','Test-WindowsDeviceLinkAssociationJwt','Test-WindowsDeviceLinkDiscovery','Test-WindowsDeviceLinkRuntime')) {
