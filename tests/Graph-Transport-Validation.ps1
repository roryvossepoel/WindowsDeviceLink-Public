...
# GET retries are limited to idempotent reads. Exercise HTTP and transport failures.
foreach($case in @(
...
# Authentication/authorization failures are not transient and must not retry.
